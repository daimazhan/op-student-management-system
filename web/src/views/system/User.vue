    ...
    <el-dialog v-model="dialogVisible" :title="dialogTitle" width="600px" @close="resetForm">
      <el-form ref="formRef" :model="formData" :rules="formRules" label-width="100px">
        ...
        <el-form-item label="密码" prop="password" v-if="!formData.id">
          <el-input v-model="formData.password" type="password" placeholder="请输入密码，为空则默认123456" show-password />
        </el-form-item>
    ...
    <el-dialog v-model="resetPasswordDialogVisible" title="重置密码" width="400px">
      <el-form ref="resetPasswordFormRef" :model="resetPasswordForm" :rules="resetPasswordRules" label-width="100px">
        ...
        <el-form-item label="新密码" prop="newPassword">
          <el-input v-model="resetPasswordForm.newPassword" type="password" placeholder="请输入新密码，为空则默认123456" show-password />
        </el-form-item>
      </el-form>
      <template #footer>
  ...
  await formRef.value.validate(async (valid) => {
    if (valid) {
      try {
        ...
        const res = formData.id ? await updateUser(submitData) : await saveUser(submitData)
        if (res.code === 200) {
